...
><span style="font-family: script; font-size: 1.5em">“If you think you are too small to make a difference, try sleeping with a mosquito”</span>
>
><span style="float:right;font-family: script; font-size: 1.2em">- The Dalai Lama</span>
>
> <span style="clear:both">&nbsp;</span>

If your checklist includes expanding your network and connections, you are not alone. You already have a team supporting you, including your Program Office. But you also have your functional community, and the network you are meeting through Digital DNA virtual events. Additional opportunities to connect through communities of practice (CoP) like the DoD Acquisition Innovators CoP are also a consideration. We are in an infinite cycle that achieves innovation, excellence, and agility through collaboration: 
...
<span style="font-family: script; font-size: 1.5em">2. Go with a Brownfield approach<span style="font-family: script; font-size: 1.5em">

As we discussed in Module 102, Greenfield and Brownfield approaches both have individual positives, but we recommend a Brownfield approach for a few reasons. It is less risky, allows the ability to navigate dependencies, provides a clear goal, and may even take less time. 
...
![Observe, Orient, Decide, Act Loop](__images/03_ooda.png)  
<span style="font-size: .8em"> Source: [Online OODA Loop Template](https://online.visual-paradigm.com/diagrams/features/ooda-loop-template/)  </span>

![Build, Measure, Learn Loop](__images/04_bml.png)  
<span style="font-size: .8em"> Source: [How Smart Meeting Practices Help You Build-Measure-Learn](https://medium.com/insights-from-meeteor/how-smart-meeting-practices-help-you-build-measure-learn-509dfc3f6c60)  </span>

![A3 Report](__images/05_a3.png)  
<span style="font-size: .8em"> Source: [Pinterest](https://www.pinterest.com/pin/349662358563170431/)  </span>
...
<tr>
    ...
    <td>
<strong>Cycle Time:</strong> After completion of each release<br>
<strong>Who:</strong> Students<br>
<strong>How:</strong> Surveys, Interviews, and Data from Learn Platform<br> 
<br>
<strong>Cycle Time:</strong> A few months after full curriculum is completed<br>
<strong>Who:</strong> Students and Supervisors<br>
<strong>How:</strong> Surveys, Interviews, and Data from Learn Platform<br>
<br>
<strong>Cycle Time:</strong> 6 months after course completion<br>
<strong>Who:</strong> Students and Supervisors<br>
...
![Digital DNA Release 1 Stats](__images/06_stats.png)
...
Methods for achieving this can vary. The context of your program--the mission, the operating environment, the users, existing and emerging contracts, or your current team can all vary. But we do believe in focusing first on your current environment. The way you implement new practices should:

1. Be Transparent and Accessible
1. Have A Balance of Perspectives, And Incorporate Multiple Roles
1. Be Timely and Flexible With Its Decisions
1. Feature Continual Learning and Improvement
1. Extend Empathy To All Communities 
...
* type: paragraph
* id: 1ba2a9fd-7fce-46a9-9cbe-8217f36c2ad2
* title: Strategy
...
Pick a format from our lesson that is used for establishing and defining feedback loops. Using that format and the guidelines below, define a strategy or approach for a recent project’s goals and intents (_what you build_) as well as inputs (_what you measure_). Then, explain how you would use it to inform change (_what you learn_).
...
## Resources
* **DOD Publication** Fox, Ronald. Defense Acquisition Reform, 1960-2009 An Elusive Goal . Center of Military History, United States Army, 2011, https://history.army.mil/html/books/051/51-3-1/CMH_Pub_51-3-1.pdf
